...
assert_eq "ACCEPTANCE.md OTHER-TOOLS.md RESEARCH.md adr plans specs" "$docs_listing" "docs/ must contain exactly ACCEPTANCE.md, OTHER-TOOLS.md, RESEARCH.md, adr/, plans/ and specs/, nothing else"
