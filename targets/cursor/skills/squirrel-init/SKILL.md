...
# squirrel-mode calibration (Cursor)
...
This writes to `~/.squirrel/profile.md`.
...
6. Once the file is written, confirm in one line. Start a new chat for the profile to take effect; this chat will not pick it up.
